#!/bin/bash
#SBATCH --job-name=tf_7680x4320
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=1
#SBATCH --output=logsTime/output_t_7680x4320off.txt
#SBATCH --error=logsTime/error_t_7680x4320off.txt
...
numOfSeams=128
optimal_loadImageThreads=1
optimal_energyThreads=1
optimal_ceFirstRowCopyThreads=1
optimal_ceRowParalelizationThreads=1
optimal_arrayShiftThreads=1
optimal_writeImageThreads=1

outputFileName="times_7680x4320_threadsOff.txt"
