#!/bin/bash
#SBATCH --job-name=scm_7680x4320
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=128
#SBATCH --output=logsMult/output_sc_7680x4320.txt
#SBATCH --error=logsMult/error_sc_7680x4320.txt
#SBATCH --time=10:00:00
#SBATCH --mem=64GB


# Define parameters
filename="7680x4320.png"
numOfSeams=128
...
optimal_loadImageThreads=12
other_loadImageThreads=(12 16 32)

optimal_energyThreads=48
other_energyThreads=(32 64 96 112 128)

optimal_ceFirstRowCopyThreads=4
other_ceFirstRowCopyThreads=(6 8 12)

optimal_ceRowParalelizationThreads=2
other_ceRowParalelizationThreads=(1 4 6 8 16)

optimal_arrayShiftThreads=12
other_arrayShiftThreads=(8 16 32 64)

optimal_writeImageThreads=16
other_writeImageThreads=(8 12 32 64)
