#!/bin/bash
#SBATCH --job-name=tf_720x480
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=1
#SBATCH --output=logsTime/output_t_720x480off.txt
#SBATCH --error=logsTime/error_t_720x480off.txt
...
outputFileName="times_720x480_threadsOff.txt"
