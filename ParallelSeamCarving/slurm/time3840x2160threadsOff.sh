#!/bin/bash
#SBATCH --job-name=tf_3840x2160
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=1
#SBATCH --output=logsTime/output_t_3840x2160off.txt
#SBATCH --error=logsTime/error_t_3840x2160off.txt
...
outputFileName="times_3840x2160_threadsOff.txt"
