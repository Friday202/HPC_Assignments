#!/bin/bash
#SBATCH --job-name=scm_3840x2160
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=128
#SBATCH --output=logsMult/output_sc_3840x2160.txt
#SBATCH --error=logsMult/error_sc_3840x2160.txt
...
other_loadImageThreads=(8 12 16 32)

optimal_energyThreads=48
other_energyThreads=(32 64 72)
