#!/bin/bash
#SBATCH --job-name=tf_1024x768
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=1
#SBATCH --output=logsTime/output_t_1024x768off.txt
#SBATCH --error=logsTime/error_t_1024x768off.txt
...
outputFileName="times_1024x768_threadsOff.txt"
