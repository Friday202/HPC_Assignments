#!/bin/bash
#SBATCH --job-name=t_1024x768
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=128
#SBATCH --output=logsTime/output_t_1024x768.txt
#SBATCH --error=logsTime/error_t_1024x768.txt
...
optimal_arrayShiftThreads=16
optimal_writeImageThreads=12

outputFileName="times_1024x768_threads.txt"
