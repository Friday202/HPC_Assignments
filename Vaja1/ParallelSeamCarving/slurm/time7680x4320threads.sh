#!/bin/bash
#SBATCH --job-name=t_7680x4320
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=128
#SBATCH --output=logsTime/output_t_7680x4320.txt
#SBATCH --error=logsTime/error_t_7680x4320.txt
