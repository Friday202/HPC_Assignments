#!/bin/bash
#SBATCH --job-name=tf_1920x1200
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=1
#SBATCH --output=logsTime/output_t_1920x1200off.txt
#SBATCH --error=logsTime/error_t_1920x1200off.txt
#SBATCH --time=10:00:00
#SBATCH --mem=64GB

# Parameters
filename="1920x1200.png"
numOfSeams=128
...
outputFileName="times_1920x1200_threadsOff.txt"
