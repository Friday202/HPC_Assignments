#!/bin/bash
#SBATCH --job-name=t_1920x1200
#SBATCH --partition=all
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --cpus-per-task=128
#SBATCH --output=logsTime/output_t_1920x1200.txt
#SBATCH --error=logsTime/error_t_1920x1200.txt
...
optimal_writeImageThreads=6

outputFileName="times_1920x1200_threads.txt"
